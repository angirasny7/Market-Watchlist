...
export const AttentionFeedPreview: React.FC = () => {
  ...
  const { events, markEventRead } = useMarketStore();

  // Sort top 5 priority events (Critical first, then High, by score DESC)
          ...
          >
            ...
            <div className="space-y-2 max-w-2xl">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="flex items-center gap-1 text-[11px] text-slate-400 font-mono ml-auto md:ml-2">
            ...
            {/* Right: Price, Delta Badge & Action */}
            <div className="flex items-center justify-between md:justify-end gap-3 shrink-0 pt-2 md:pt-0 border-t md:border-t-0 border-border/60">
              <div className="text-right">
                <div className="text-sm font-mono font-bold text-slate-100 tabular-numbers">
                  {formatPrice(event.price, event.stockSymbol === 'AMZN' ? '$' : '₹')}
                </div>
